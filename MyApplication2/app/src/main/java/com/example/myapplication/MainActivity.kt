    ...
    inner class MiTareaAsync : AsyncTask<Void, Void, String>() {
        ...
        override fun doInBackground(vararg params: Void?): String {
            ...
            val request = Request.Builder()
                .url("http:/10.178.3.212:8080/RESTNotificaciones/webresources/generic/hola/"+mensaje.text.toString())
                .build()
    ...
    inner class MiTareaAsync2 : AsyncTask<Void, Void, String>() {
        ...
        override fun doInBackground(vararg params: Void?): String {
            val client = OkHttpClient.Builder()
                ...
                .build()
            val request = Request.Builder()
                .url("http:/192.168.0.14:8080/RESTNotificaciones/webresources/generic/recibir/"+cola.text.toString())
                .build()
            val response = client.newCall(request).execute()
            return response.body?.string() ?: ""
        }
